# AI-Based Text Extraction from Scanned Documents (AWS Textract)

Developed a Python-based OCR desktop application using AWS Textract to extract structured text from scanned and handwritten
documents.
